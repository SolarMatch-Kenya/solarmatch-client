...
const SustainabilityIcon = () => (
    <svg
        ...
        height="48"
        fill="currentColor"
        className="bi bi-leaf mx-auto text-primary"
        viewBox="0 0 16 16"
    >
...
const TransparencyIcon = () => (
    <svg
        ...
        height="48"
        fill="currentColor"
        className="bi bi-eye mx-auto text-primary"
        viewBox="0 0 16 16"
    >
        ...
        <div className="app-container">
            <div className="home-container">
                ...
                <div className="body">
                    ...
                    <div className="py-20">
                        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                            <h2 className="h2 text-primary">Connect with us</h2>
                            <p className="text-lg mt-6 max-w-3xl mx-auto text-gray-700">
