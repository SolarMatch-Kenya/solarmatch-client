        ...
        <div className="app-container">
            <div className="home-container">
                ...
                <div className="body">
                    ...
                    {/* Hero section */}
                    <div className="hero relative bg-cover bg-center h-[80vh] flex items-center justify-center" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1655300283246-1ef0317a565d?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=3131)' }}>
                        <div className="absolute inset-0 bg-black/70"></div>
                        <div className="container mx-auto px-8 py-30 mb-8 relative text-center max-w-7xl">
                            <h1 className="text-4xl font-bold lg:text-5xl text-white tracking-tight">Find out if your home is perfect for solar <br />— in just 3 minutes.</h1>
                    ...
                    <div className="container mx-auto px-6 py-4 max-w-7xl">
                        ...
                        <div className="onboarding-steps py-12">
                            <h2 className="text-3xl font-bold lg:text-4xl text-[#006800] mb-4 text-center">Get Started in 3 Simple Steps</h2>
                    ...
                    <div className="testimonials bg-linear-to-b from-green-50 to-[#133b04] py-20">
                        <div className="container mx-auto px-8 max-w-7xl">
                            <h2 className="text-3xl font-bold lg:text-4xl text-[#006800] mb-4 text-center">What Our Users Say</h2>
                            <div className="testimonials-list mt-10 grid grid-cols-1 md:grid-cols-3 gap-8">
                                <div className="testimonial-item bg-white p-8 rounded-lg text-center">
                                    ...
                                    <span className="font-bold mt-4">- Okwiri D. - </span>
                                </div>
                                <div className="testimonial-item bg-white p-8 rounded-lg text-center">
